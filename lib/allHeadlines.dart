...
class AllHeadlines extends StatefulWidget {
  AllHeadlines({Key key, this.title, this.provider}) : super(key: key);
  final String title;
  final List provider;

  @override
  _AllHeadlinesState createState() => new _AllHeadlinesState();
}

class _AllHeadlinesState extends State<AllHeadlines> {
  @override
