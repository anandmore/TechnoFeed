...
class CustomHeadlines extends StatefulWidget {
  CustomHeadlines({Key key, this.title, this.provider}) : super(key: key);
  final String title;
  final List provider;

  @override
  _CustomHeadlinesState createState() => new _CustomHeadlinesState();
}

class _CustomHeadlinesState extends State<CustomHeadlines> {
  @override
